...
namespace KinematicCharacterController
{
    ...
    public class KinematicCharacterSystem : MonoBehaviour
    {
        ...
        public static List<B_KinematicCharacterMotor> CharacterMotors = new List<B_KinematicCharacterMotor>();
        ...
        /// </summary>
        public static void RegisterCharacterMotor(B_KinematicCharacterMotor motor)
        {
        ...
        /// </summary>
        public static void UnregisterCharacterMotor(B_KinematicCharacterMotor motor)
        {
        ...
        public static void PreSimulationInterpolationUpdate(float deltaTime)
        {
            ...
            {
                B_KinematicCharacterMotor motor = CharacterMotors[i];
        ...
        /// </summary>
        public static void Simulate(float deltaTime, List<B_KinematicCharacterMotor> motors, List<PhysicsMover> movers)
        {
...
#pragma warning disable 0162
            ...
            for (int i = 0; i < characterMotorsCount; i++)
            {
                B_KinematicCharacterMotor motor = motors[i];
